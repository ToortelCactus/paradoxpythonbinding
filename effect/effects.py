...
class E:
    ...
    @staticmethod
    def add_modifier(mod: Modifier, months: int):
        """
        ...
        **Supported Scopes**: country, building, character, institution, interest_group, journalentry, political_movement, state
        """
        return default_list(inspect.stack()[0][3], [eq("name", mod.name), eq("months", str(months))])
    ...
    @staticmethod
    def remove_modifier(mod: Modifier):
        """

        Removes a timed modifier effect to object in scope
        **Supported Scopes**: country, building, character, institution, interest_group, journalentry, political_movement, state
        """
        return default(inspect.stack()[0][3], mod)
